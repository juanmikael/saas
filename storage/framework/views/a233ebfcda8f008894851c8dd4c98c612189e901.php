...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid" style="padding-left:30px">
    ...
    <svg style="margin-right:10px" class="img-fluid" width="55" height="50" viewBox="0 0 58 53" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg><span class="f-12">Workkit</span></a>
        ...
        <script>
            $(function() {
                ...
                chatInput.keypress(function(e) {
                    ...
                    var name = '<?php echo e($LoggedUserInfo['fullname']); ?>';
                    console.log(message);
...
<?php /**PATH C:\Users\Citycom\Desktop\New folder\saas\resources\views/dashboard.blade.php ENDPATH**/ ?>